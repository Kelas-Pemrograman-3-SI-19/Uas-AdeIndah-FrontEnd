...
<q-table
    ...
    >
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td key="namaPesertaDidik" :props="props">
            {{ props.row.namaPesertaDidik }}
          </q-td>
          ...
          <q-td key="aksi" :props="props">
            <div class="q-pa-md q-gutter-sm">
              <div class="col">
                <q-btn  label="Edit" :to="{ name: 'formEditSiswa', params: { id: props.row._id}}" color="warning" icon="edit" unelevated />
               </div>
              <div class="col">
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'namaPesertaDidik', align: 'center', label: 'Nama Siswa', field: 'namaPesertaDidik', sortable: true },
